...
I will choose the fourth one with less error both in train set and validation set
...
```
As complexity increases, the misclassification errors in both train set and validation set decreases, which shows that the fourth model is the best one.
