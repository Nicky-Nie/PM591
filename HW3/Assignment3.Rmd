...
```
I will choose k=26 since the sequence of data with ce=0.4102564 gives a more convincing low ce compared to those with lower ce but only three points shown in the plot. And among those with 0.4102564 ce, k=26 provides the simplist model. 
